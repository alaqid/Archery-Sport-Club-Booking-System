...
<body class="fadeIn first">
    ...
    <div class="a3">
        ...
        echo "<table class='dataTable'>
            ...
            ?>
            <td><a href="update-process.php?booking_id=<?php echo $rows["booking_id"]; ?>"> <button style="background:grey; color:white;">Update</button></a>
            <a href="delete-process.php?booking_id=<?php echo $rows["booking_id"]; ?>"> <button style="background:#b51616; color:white;">Delete</button></a></td>
