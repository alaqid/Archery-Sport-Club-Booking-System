...
session_start(); 
	...
	$result=mysqli_query($db,$sql);
	  ...
	  if (isset($_POST['paygold'])) { 
        $query ="UPDATE users SET member_level='GOLD' WHERE id='".$id."'";
        mysqli_query($db, $query);
		echo "<script>
alert('Successfully Subscribed to Gold');
...
<div class="wrapper fadeInDown">
  <div id="formContent">
    ...
    <!-- Login Form -->
    <form method="post" action="paymentGold.php">
      ...
      <button type="submit" class="btn" name="paygold">Pay</button>	  
    </form>
